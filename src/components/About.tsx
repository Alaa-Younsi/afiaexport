      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 lg:px-16 xl:px-24">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-16 items-center">
          ...
          <div className={isRtl ? 'text-right' : ''}>
            ...
            <div
              className={`${isRtl ? 'border-r-4 border-secondary pr-6' : 'border-l-4 border-secondary pl-6'} py-1`}
            >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 md:grid-cols-1 lg:grid-cols-3 gap-4">
            {[
              ...
              >
                <div className="text-3xl md:text-4xl font-bold text-secondary mb-2 font-playfair" style={fontAr}>
                  {num}
                </div>
